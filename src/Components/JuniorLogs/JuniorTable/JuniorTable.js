            ...
            {junior_table_logs.filter(item =>{
                ...
                return (
                    <tr className={`junior-table-row-container`}>
                        <td className={`junior-table-data-container ${item.handover_flag==='yes'?(item.delete_flag==='yes'?'bg-light-red':'bg-moon-gray fw5'):'bg-white'}`} data-label={'Lead ID'}>{item.lead_id}</td>
                        <td className={`junior-table-data-container ${item.handover_flag==='yes'?(item.delete_flag==='yes'?'bg-light-red':'bg-moon-gray fw5'):'bg-white'}`} data-label={'Assigned to'}>{item.assigned_to}</td>
                        ...
                        <td className={`junior-table-data-container ${item.handover_flag==='yes'?(item.delete_flag==='yes'?'bg-light-red':'bg-moon-gray fw5'):'bg-white'}`} data-label={'Status 1'}>{`${item.status_1?item.status_1:"NULL"}`}</td>
                        <td className={`junior-table-data-container ${item.handover_flag==='yes'?(item.delete_flag==='yes'?'bg-light-red':'bg-moon-gray fw5'):'bg-white'}`} data-label={'Status 2'}>{`${item.status_2?item.status_2:"NULL"}`}</td>
